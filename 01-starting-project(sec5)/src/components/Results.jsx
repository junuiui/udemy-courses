...
export default function Results({ inputs }) {
    ...
    const initialInvestments = resultArr[0].valueEndOfYear - resultArr[0].interest - resultArr[0].annualInvestment;
