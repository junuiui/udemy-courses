...
export default function WelcomePage() {
  ...
  /**
   * takes the value (scrollY) then, 
   * second: breakpoint for Y-axis 
   * third: breakpoint for y-position and transparent,
   * DOES NOT IMPACT THE RENDER CYCLE
   */
  ...
  return (
    <>
      <header id="welcome-header">
        {/* need to findout how fast user scroll */}
